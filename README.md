...
`ORESoftware` is a GitHub user namespace rather than a GitHub Organization. It is the explicit owner-namespace exception for this otherwise organization-oriented mapping. No Supabase projects currently exist.

## Project inventory

| Project ref | Local slug | Canonical | Provider status | Git working directory | Integration |
|---|---|---:|---|---|---|
| — | No hosted projects discovered | — | — | — | — |
